<?php
    ...
    class resourceView extends resource {
        ...
        function dispResourceIndex() {
            ...
            Context::set('package_categories', $oResourceModel->getCategoryPackageCount($this->module_srl));
        }
        ...
        function dispResourcePackage() {
            ...
            if(!$package_srl || !$selected_package) return new BaseObject('msg_invalid_request');
        ...
        function dispResourceManage() {
            ...
            if(!$this->grant->manager) return new BaseObject(-1,'msg_not_permitted');
